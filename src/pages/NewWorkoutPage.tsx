      ...
      {type === "strength" ? (
        <div className="flex flex-col gap-3">
          ...
          <button
            ...
            className="flex h-32 w-full flex-col items-center justify-center gap-2 rounded-xl border-2 border-dashed border-strength/40 text-strength transition-colors hover:bg-strength/10 active:bg-strength/10"
          >
