...
// Muscle regions are schematic exercise targets, not an exhaustive list or activation measurements.
// Mappings use the existing plan cues and NASM exercise-library target groups:
...
const floatingHeelDrop: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "calf", side: "near" }],
...
const doubleLegCalfRaiseOnStep: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "calf", side: "both" }],
...
const singleLegCalfRaise: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "calf", side: "near" }], view: "side", duration: 3.2, keyframes: [flat, up, up, flat], weights: [1, 0.5, 1.2, 0.5], props: [FLOOR_88], anchor: { leg: "near", joint: "toe" } };
})();

// Squat down, stand, rise onto the toes.
const squatToCalfRaise: StickFigureSpec = { muscleTargets: [{ region: "quads", side: "both" }, { region: "glutes", side: "both" }, { region: "calf", side: "both" }],
...
const lungeHoldCalfRaise: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "calf", side: "near" }, { region: "quads", side: "near" }], view: "side", duration: 3.2, keyframes: [down, up, up, down], weights: [1, 0.6, 1, 0.6], props: [FLOOR_88], anchor: { leg: "near", joint: "toe" }, cue: "弓步位" };
})();
...
const toeWalk: StickFigureSpec = { muscleTargets: [{ region: "calf", side: "both" }], view: "side", duration: 1.2, keyframes: toeWalkPoses, props: [FLOOR_88], cue: "踮脚走 · 小腿三头肌和足内在肌" };

const loadedWalkingCalfRaise: StickFigureSpec = { muscleTargets: [{ region: "calf", side: "both" }],
...
const heelWalk: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "shins", side: "both" }], view: "side", duration: 1.2, keyframes: [a, b], props: [FLOOR_88], cue: "脚跟着地走、脚尖抬起 · 胫前肌，对应胫骨痛预防" };
})();
...
const bandedToeRaise: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "shins", side: "both" }], view: "side", duration: 2, keyframes: [down, up], props: [FLOOR_86], cue: "胫前肌，防胫骨痛" };
})();
...
const pogoJump: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "calf", side: "both" }], view: "side", duration: 0.8, keyframes: [ground, air], props: [FLOOR_88], cue: "落地要轻、脚踝主导、不要蹲下去" };
})();

// ── Walking, carries, standing drills ────────────────────────────────────────

const standingMarch: StickFigureSpec = { muscleTargets: [{ region: "hipFlexors", side: "both" }],
...
const suitcaseCarry: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "obliques", side: "near" }], view: "side", duration: 1.4, hold: ["near"], keyframes: [a, b], props: [FLOOR_88], cue: "单手提（手提箱式）才练抗侧屈" };
})();
...
const lateralWalk: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "outerHip", side: "both" }], view: "front", duration: 1.6, keyframes: [wide, narrow], props: [FLOOR_88] };
})();
...
const sideLunge: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "quads", side: "near" }, { region: "adductors", side: "both" }], view: "front", duration: 3, keyframes: [stand, lunge, lunge, stand], weights: [1, 0.5, 1, 0.4], props: [FLOOR_88], anchor: { leg: "near", joint: "ankle" }, cue: "侧向负重" };
})();
...
const sideLegSwing: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "outerHip", side: "near" }, { region: "adductors", side: "near" }], view: "front", duration: 1.8, keyframes: [out, across], props: [FLOOR_88] };
})();
...
const hipDrop: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "outerHip", side: "near" }],
...
const singleLegSldlKneeDrive: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "hamstrings", side: "near" }, { region: "glutes", side: "near" }, { region: "hipFlexors", side: "far" }],
...
const staggeredStanceRdl: StickFigureSpec = { muscleTargets: [{ region: "hamstrings", side: "near" }, { region: "glutes", side: "near" }],
...
const singleLegSquat: StickFigureSpec = { muscleTargets: [{ region: "quads", side: "near" }, { region: "glutes", side: "near" }], view: "side", duration: 3.2, keyframes: singleLegSquatPoses, weights: [2, 1.2], props: [FLOOR_88], anchor: { leg: "near", joint: "ankle" } };

// Same single-leg squat, lowering slowly onto a box behind.
const squatOntoOneLeg: StickFigureSpec = { muscleTargets: [{ region: "quads", side: "near" }, { region: "glutes", side: "near" }],
...
const bStanceHipThrust: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "glutes", side: "near" }, { region: "hamstrings", side: "near" }], view: "side", duration: 3.1, keyframes: [bottom, top, top, bottom], weights: [1, 0.6, 1, 0.5], props: [{ kind: "floor", y: 85 }, HIP_THRUST_BENCH] };
})();
...
const gluteBridgeHamstringWalkout: StickFigureSpec = { muscleTargets: [{ region: "hamstrings", side: "both" }, { region: "glutes", side: "both" }],
...
const singleLegIsometricHamstringHold: StickFigureSpec = { muscleTargets: [{ region: "hamstrings", side: "near" }, { region: "glutes", side: "near" }],
...
const hollowBody: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "abs", side: "near" }], view: "side", duration: 4.6, keyframes: [flat, hollow, hollow, flat], weights: [1, 2, 1, 0.6], props: [FLOOR_86], cue: "抗伸展" };
})();
...
const legLower: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "abs", side: "near" }, { region: "hipFlexors", side: "both" }], view: "side", duration: 4, keyframes: [up, down], weights: [3, 1], props: [FLOOR_86], cue: "抗伸展 + 骨盆控制" };
})();
...
const backPlank: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "glutes", side: "both" }, { region: "hamstrings", side: "both" }], view: "side", duration: 4, keyframes: [sit, up, up, sit], weights: [1, 1.5, 1, 0.6], props: [FLOOR_86], cue: "前链拉开 + 后链激活" };
})();
...
const bearCrawl: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "abs", side: "near" }, { region: "shoulders", side: "both" }],
    view: "side", duration: 2.4, props: [FLOOR_88],
...
const legLift: StickFigureSpec = { muscleTargets: [{ region: "outerHip", side: "near" }],
  view: "front", duration: 3, keyframes: [legLiftPoses[0], legLiftPoses[1], legLiftPoses[1], legLiftPoses[0]], weights: [1, 0.5, 1, 0.5],
  props: [MAT], cue: "臀中肌",
};
const legLiftHold: StickFigureSpec = { muscleTargets: [{ region: "outerHip", side: "near" }],
...
const sidePlankLegRaise: StickFigureSpec = { muscleTargets: [{ region: "obliques", side: "near" }, { region: "outerHip", side: "near" }],
  view: "front", duration: 2.4, keyframes: [SIDE_PLANK, { ...SIDE_PLANK, legNear: [110, 110, 180] }], props: [FLOOR_90],
  cue: "抗侧屈叠加臀中肌",
};

const sidePlankHipFlexion: StickFigureSpec = { muscleTargets: [{ region: "obliques", side: "near" }, { region: "hipFlexors", side: "near" }],
...
const copenhagenShortLever: StickFigureSpec = (() => {
  ...
  return { muscleTargets: [{ region: "adductors", side: "near" }, { region: "obliques", side: "near" }],
...
const pressUpPositionWalkOut: StickFigureSpec = { muscleTargets: [{ region: "abs", side: "near" }, { region: "shoulders", side: "both" }],
...
const travellingPressUpWalkOut: StickFigureSpec = { muscleTargets: [{ region: "chest", side: "near" }, { region: "triceps", side: "both" }, { region: "abs", side: "near" }],
...
const pressUpSingleArmExtension: StickFigureSpec = { muscleTargets: [{ region: "abs", side: "near" }, { region: "shoulders", side: "both" }],
...
function stepDown(): StickFigureSpec {
  return {
    muscleTargets: [{ region: "quads", side: "near" }, { region: "glutes", side: "near" }],
